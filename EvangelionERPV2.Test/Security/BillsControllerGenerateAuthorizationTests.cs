...
{
    public class BillsControllerGenerateAuthorizationTests
    {
        ...
        [Fact]
        public async Task Generate_ReturnsUnauthorized_WhenEnterpriseClaimIsMissing()
        {
            var controller = CreateController(Array.Empty<Claim>());

            var response = await controller.Generate(Guid.NewGuid());
        ...
        [Fact]
        public async Task Generate_ReturnsNoContent_WhenOrderIsNotFoundForEnterprise()
        {
            ...
            var response = await controller.Generate(orderId);
        ...
        [Fact]
        public async Task Generate_ReturnsOk_WhenOrderBelongsToEnterprise()
        {
            var orderId = Guid.NewGuid();
            var enterpriseId = Guid.NewGuid();
            var userId = Guid.NewGuid();
