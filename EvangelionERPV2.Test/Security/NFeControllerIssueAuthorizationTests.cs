...
{
    public class NFeControllerIssueAuthorizationTests
    {
        ...
        [Fact]
        public async Task Issue_ReturnsUnauthorized_WhenEnterpriseClaimIsMissing()
        {
            var controller = CreateController(Array.Empty<Claim>());

            var response = await controller.Issue(Guid.NewGuid());
        ...
        [Fact]
        public async Task Issue_ReturnsNoContent_WhenOrderIsNotFoundForEnterprise()
        {
            ...
            var response = await controller.Issue(orderId);
        ...
        [Fact]
        public async Task Issue_ReturnsOk_WhenOrderBelongsToEnterprise()
        {
            var orderId = Guid.NewGuid();
            var enterpriseId = Guid.NewGuid();
            var userId = Guid.NewGuid();
