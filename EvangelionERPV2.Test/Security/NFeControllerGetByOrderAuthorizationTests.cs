...
{
    public class NFeControllerGetByOrderAuthorizationTests
    {
        ...
        public async Task GetByOrder_ReturnsUnauthorized_WhenEnterpriseClaimIsMissing()
        {
            ...
            _nfeServiceMock.Verify(
                x => x.GetByOrderIdAsync(It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<NFeDocumentType?>()),
                Times.Never);
        }
        ...
        public async Task GetByOrder_ReturnsOk_WhenOrderBelongsToEnterprise()
        {
            ...
            _nfeServiceMock
                .Setup(x => x.GetByOrderIdAsync(orderId, enterpriseId, null))
