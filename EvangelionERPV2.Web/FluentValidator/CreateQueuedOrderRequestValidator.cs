...
{
    public sealed class CreateQueuedOrderRequestValidator : AbstractValidator<CreateQueuedOrderRequestDTO>
    {
        public CreateQueuedOrderRequestValidator()
        {
            RuleFor(x => x.EnterpriseId)
                .NotEmpty().WithMessage("EnterpriseId is required.");
