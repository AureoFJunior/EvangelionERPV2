...
namespace EvangelionERPV2.ProductModule.Domain.Repositories
{
    ...
    {
        protected readonly ProductModuleDbContext _context;

        public Repository(ProductModuleDbContext context)
        {
            _context = context;
        }
        ...
        public virtual async Task<(IEnumerable<TEntity>, int)> GetAllAsyncByFilter(bool descending,
            int? pageNumber,
            int? pageSize,
