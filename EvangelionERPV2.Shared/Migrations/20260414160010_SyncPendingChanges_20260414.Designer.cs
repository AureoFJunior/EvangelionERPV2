...
namespace EvangelionERPV2.Shared.Migrations
{
    ...
    [Migration("20260414160010_SyncPendingChanges_20260414")]
    partial class SyncPendingChanges_20260414
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EvangelionERPV2.Shared.Entities.User", b =>
                {
                    ...
                    b.HasIndex("EnterpriseId", "NormalizedActiveEmail")
                        .IsUnique()
                        .HasDatabaseName("IX_User_EnterpriseId_NormalizedActiveEmail_Active")
